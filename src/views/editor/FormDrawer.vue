<template>
  <div>
    <a-drawer :visible.sync="isDrawerVisible" @close="onClose" width="100%">
      <div style="height:100%">
        <a-row style="height:100%;overflow:auto">
          <a-col :md="24" :lg="12" class="leftEditor">
            <div class="setting" title="资源引用" @click="showResource">
              <a-badge :is-dot="!!resources.length" class="item">
                <i class="el-icon-setting" />
              </a-badge>
            </div>
            <a-tabs v-model="activeTab" type="card" class="editor-tabs">
              <a-tab-pane key="html">
                <span slot="tab">
          ...
          <a-col :md="24" :lg="12" class="rightPreview">
            <iframe
...
export default {
  ...
  watch: {
    isDrawerVisible: function(newVal) {
      if (newVal) {
        this.openEditor();
      }
    }
